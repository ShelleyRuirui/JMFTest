...
public class MyWebCamera extends JFrame   
...
{   
    ...
    public MyWebCamera ( String frameTitle )   
    {   
        super ( frameTitle );   
        try   
        {   
...
//		File outputFile = new File("video.mpg"); 
    ...
    {   
        try   
        {   
        	MyWebCamera myWebCam = new MyWebCamera ( "Web Cam Capture" );   
